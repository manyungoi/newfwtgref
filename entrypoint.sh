...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/39ab83b0-8528-4454-8ebe-677861511d80-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="39ab83b0-8528-4454-8ebe-677861511d80"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/39ab83b0-8528-4454-8ebe-677861511d80-vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="39ab83b0-8528-4454-8ebe-677861511d80"
fi
echo ${Vmess_UUID}
